...
export const Appoint: FC = () => {
  ...
  return (
    <div className="flex w-full items-center justify-center">
      ...
      {loaded && !(loading || listData.loading) && selectedAppoint && !error && (
        <div className="w-full rounded-xl border-2 border-gray-200 p-6">
                      ...
                      {['0', '1', '2'].map((conItem, index) => (
                        <div key={index}>
                          <span>
                            {el.conjunction[
                              (index + 1) as 1 | 2 | 3
                            ].mcbRecommendation.trim().length > 0
                              ? el.conjunction[
                                  (index + 1) as 1 | 2 | 3
          ...
          <div className="mt-3.5 flex flex-col">
            <span className="text-xs text-gray-500">Результат проверки</span>
                  ...
                  appointStatusToColor(
                    scoreNumToStatus(
                      selectedAppoint?.result?.max === 100
                        ? 100
                        : selectedAppoint?.result?.average ?? 0
                    )
                  ),
